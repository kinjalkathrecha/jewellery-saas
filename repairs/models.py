...
class Repair(models.Model):
    ...
    assigned_to = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='assigned_repairs')
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.CheckConstraint(check=models.Q(item_weight__gte=0) | models.Q(item_weight__isnull=True), name="repair_item_weight_positive"),
        ]
