...
class RepairUpdateView(LoginRequiredMixin, ShopFilterMixin, UpdateView):
    ...
    def form_valid(self, form):
        ...
        if old_status != new_status:
            ...
            try:
                process_repair_status_change(
                    repair=old_repair, to_status=new_status, user=self.request.user, notes="Updated via edit form."
                )
...
class RepairStatusUpdateView(LoginRequiredMixin, ShopFilterMixin, View):
    ...
    def post(self, request, pk):
        ...
        try:
            process_repair_status_change(repair=repair, to_status=to_status, user=request.user, notes=notes)
