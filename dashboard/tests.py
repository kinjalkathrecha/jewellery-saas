...
class DashboardReportsTestCase(TestCase):
    def setUp(self):
        ...
        # 2. Setup Shop
        self.shop = Shop.objects.create(name="Test Shop", email="test@reports.com", phone_number="12345")
        ...
        self.user = CustomUser.objects.create_user(
            username="reportsadmin", email="reports@test.com", password="testpassword", shop=self.shop, role="ADMIN"
        )
